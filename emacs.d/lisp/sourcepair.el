...
(defcustom sourcepair-source-extensions '( ".cpp" ".cxx" ".cc" ".C" ".c" ".cu" ".cl" ".m" ".mm" ".tpp")
...
value is ( \".cpp\" \".cxx\" \".cc\" \".C\" \".c\"  \".tpp\"), and you are looking at
\"foo.h\", `sourcepair-load' will look for \"foo.cpp\", \"foo.cxx\",
\"foo.cc\", \"foo.c\" or \"foo.tpp\" in that order in the directories specified by
`sourcepair-source-path'."
:type '(repeat string))

(defcustom sourcepair-header-extensions '( ".h" ".hpp" ".hh" ".cuh" )
